      ...
      <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
        <div className="space-y-6 rounded-[2rem] bg-white p-8 shadow-sm">
          <div className="rounded-[1.5rem] bg-green-100 p-10 text-center text-text">
            <div className="mx-auto flex h-72 w-full items-center justify-center rounded-[1.5rem] bg-white text-2xl font-semibold text-primary">
              Dr. Zainab Photo
            </div>
          </div>
          <div className="space-y-4">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-secondary">About Dr. Zainab</p>
            <h1 className="text-4xl font-semibold text-text">Dr. Zainab Mohsin, MBBS, FCPS</h1>
            <p className="text-base leading-7 text-text-muted">
              Dr. Zainab Mohsin is a consultant gynecologist and obstetrics specialist with over 10 years of experience supporting Pakistani mothers through pregnancy, delivery, and newborn care.
            </p>
          </div>
          <div className="space-y-4 text-sm leading-7 text-text-muted">
            ...
            <p>
              Dr. Zainab believes every mother deserves to be informed, empowered, and supported through every stage of pregnancy and beyond.
            </p>
          </div>
